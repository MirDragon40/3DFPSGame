...
public class LobbyScene : MonoBehaviour
{
    ...
    public void OnClickLoginButton()
    {
        ...
        Debug.Log(PlayerPrefs.HasKey(id));
        Debug.Log(PlayerPrefs.HasKey(pw));
